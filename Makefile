...
world:
	...
	DEVICE=RK3326_720 ARCH=aarch64 ./scripts/build_distro
RG351P:
	DEVICE=RG351P ARCH=aarch64 ./scripts/build_distro
...
lib32:
	...
	DEVICE=RK3326_720 ARCH=arm scripts/clean build-lib32
	...
	DEVICE=RK3326_720 ARCH=arm scripts/build build-lib32
