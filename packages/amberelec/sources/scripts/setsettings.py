...
def set_settings(rom_name: str, core: str, platform: str, controllers: str, autosave: str, snapshot: str) -> str:
    ...
    if device_name == "RG351P":
        ...
        system_viewport = {
            ...
            'gb': (0, 0, 1280, 1152),                # x8
            'gbh': (0, 0, 1280, 1152),               # x8
            'gbc': (0, 0, 1280, 1152),               # x8
            'gbch': (0, 0, 1280, 1152),              # x8
            'supervision': (0, 32, 1120, 1120),      # x7
            'gamegear': (0, 0, 1280, 1152),          # x8
            'ggh': (0, 0, 1280, 1152),               # x8
            'pokemini': (0, 384, 1152, 768),         # x12
            'ngp': (0, 88, 1120, 1064),              # x7
            'ngpc': (0, 88, 1120, 1064),             # x7
            'wonderswan': (0, 576, 896, 576),        # x4
            'wonderswancolor': (0, 576, 896, 576),   # x4
            'gba': (0, 352, 1200, 800),              # x5
            'gbah': (0, 352, 1200, 800),             # x5
