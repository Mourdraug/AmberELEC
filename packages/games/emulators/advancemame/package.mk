...
PKG_VERSION="a92fe760905cdcc39a68a82093a1d849182eed73"
PKG_SHA256="8fb71022279ac0a2a5882fb899e5817374e5ec9f870df2efb1aab3087da77353"
PKG_LICENSE="MAME"
...
post_make_target() {
  ...
  if [ "${DEVICE}" = "RG351MP" ] || [ "${DEVICE}" = "RK3326_720" ] || [ "${DEVICE}" = "RG552" ]; then
