...
PKG_NAME="raze"
PKG_VERSION="8105bc1d4fa2f701d2abe890761c026f2d9fe43f"
PKG_LICENSE="GPL"
...
if [ ! "${DEVICE}" = "RG351MP" ] && [ ! "${DEVICE}" = "RG552" ] && [ ! "${DEVICE}" = "RK3326_720" ]
then
...
makeinstall_target() {
  ...
  if [ "${DEVICE}" = "RG351MP" ] || [ "${DEVICE}" = "RG552" ] || [ "${DEVICE}" = "RK3326_720" ]; then
